...
<style>
  ...
  figcaption {
    ...
    font-size: 0.85em;                /* Makes the caption smaller than main text */
    font-style: italic;               /* Adds an italic effect */
    text-align: center;               /* Keeps the caption centered under the plot */
    margin-top: 10px;                 /* Adds a little breathing room above the caption */
  }
</style>

My research focus is observational X-ray astronomy of galaxy clusters. I use data from space-based X-ray missions combined with ground-based optical data to probe the hot intergalactic plasma that is making up more than 90% of all matter in our Universe. 
